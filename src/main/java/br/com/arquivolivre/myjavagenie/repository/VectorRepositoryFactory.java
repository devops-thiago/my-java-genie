...
/**
 * Factory for creating VectorRepository instances based on configuration.
 * Supports ChromaDB initially, with extensibility for pgvector and Qdrant.
 */
@Component
public class VectorRepositoryFactory {
     ...
     * @throws InvalidConfigurationException if the database type is not supported or configuration is invalid
     */
