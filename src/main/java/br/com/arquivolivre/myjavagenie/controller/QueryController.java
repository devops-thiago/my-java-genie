 ...
 * Provides endpoint for users to ask questions about Java 25 documentation.
 */
@RestController
@RequestMapping("/api")
@Validated
public class QueryController {
    ...
    /**
     * Exception handler for ModelTimeoutException.
     * Returns 504 Gateway Timeout when model generation times out.
     */
    ...
    /**
     * Exception handler for ModelInvocationException.
     * Returns 503 Service Unavailable when model invocation fails.
     */
    ...
    /**
     * Exception handler for VectorDbException.
     * Returns 503 Service Unavailable when vector database operations fail.
     */
    ...
    /**
     * Exception handler for general RagSystemException.
