 ...
 * Provides centralized error handling and logging with detailed stack traces.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleValidationException(
        ...
        logger.error("Validation error on request to {}: {}",
    ...
    public ResponseEntity<ErrorResponse> handleIllegalArgumentException(
        ...
        logger.error("Invalid argument on request to {}: {}",
    ...
    public ResponseEntity<ErrorResponse> handleModelTimeoutException(
        ...
        logger.error("Model timeout on request to {}: {}",
                request.getDescription(false), ex.getMessage(), ex);
    ...
    public ResponseEntity<ErrorResponse> handleModelInvocationException(
        ...
        logger.error("Model invocation failed on request to {}: {}",
                request.getDescription(false), ex.getMessage(), ex);
    ...
    public ResponseEntity<ErrorResponse> handleModelInitializationException(
        ...
        logger.error("Model initialization failed on request to {}: {}",
                request.getDescription(false), ex.getMessage(), ex);
    ...
    public ResponseEntity<ErrorResponse> handleVectorDbException(
        ...
        logger.error("Vector database error on request to {}: {}",
                request.getDescription(false), ex.getMessage(), ex);
    ...
    public ResponseEntity<ErrorResponse> handleIngestionException(
        ...
        logger.error("Ingestion failed on request to {}: {}",
                request.getDescription(false), ex.getMessage(), ex);
    ...
    public ResponseEntity<ErrorResponse> handleConfigurationException(
        ...
        logger.error("Configuration error on request to {}: {}",
                request.getDescription(false), ex.getMessage(), ex);
    ...
    public ResponseEntity<ErrorResponse> handleRagSystemException(
        ...
        logger.error("RAG system error on request to {}: {}",
                request.getDescription(false), ex.getMessage(), ex);
    ...
    public ResponseEntity<ErrorResponse> handleGlobalException(
        ...
        logger.error("Unexpected error on request to {}: {}",
                request.getDescription(false), ex.getMessage(), ex);
