 ...
 */
public record ChatMessage(String id, MessageRole role, String content, Instant timestamp,
    ...
    public ChatMessage(MessageRole role, String content, List<SourceReference> sources) {
        this(UUID.randomUUID().toString(), role, content, Instant.now(), sources != null ? new ArrayList<>(sources) : new ArrayList<>());
    }
