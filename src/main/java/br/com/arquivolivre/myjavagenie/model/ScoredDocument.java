...
/**
 * Wraps a DocumentChunk with its similarity score from a vector database search. Used to represent
...
public class ScoredDocument {
  ...
  public String toString() {
    return "ScoredDocument{" + "chunk=" + chunk + ", similarityScore=" + similarityScore + '}';
  }
}
