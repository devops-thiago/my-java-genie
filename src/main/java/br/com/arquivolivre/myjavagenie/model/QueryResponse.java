 ...
 * Contains the generated answer, source references, token usage metrics, and response time.
 */
public class QueryResponse {
    ...
    public QueryResponse(String answer, List<SourceReference> sources,
                         TokenUsageMetrics tokenUsage, long responseTimeMs) {
        this.answer = answer;
    ...
    public QueryResponse(String answer, List<SourceReference> sources,
                         TokenUsageMetrics tokenUsage, long responseTimeMs, String sessionId) {
        this.answer = answer;
        this.sources = sources != null ? sources : new ArrayList<>();
        this.tokenUsage = tokenUsage;
        this.responseTimeMs = responseTimeMs;
