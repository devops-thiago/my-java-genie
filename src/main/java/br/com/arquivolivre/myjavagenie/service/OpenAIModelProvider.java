...
/**
 * Language model provider for OpenAI API.
 * Implements token usage tracking from API responses.
 */
    ...
    public GenerationResponse generate(GenerationRequest request) {
        ...
        while (attempt < MAX_RETRIES) {
            try {
                ...
                logger.info("OpenAI estimated token usage - prompt: {}, completion: {}, total: {}",
