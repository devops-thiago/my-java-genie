...
/**
 * Service for recording custom OpenTelemetry metrics for the RAG system.
 * Tracks query performance, token usage, and error rates.
 */
@Service
...
public class MetricsService {
     ...
     */
    public void recordQuerySuccess(String provider, String model, long durationMs,
        ...
        logger.debug("Recorded successful query metrics: provider={}, model={}, duration={}ms, " +
                        "promptTokens={}, completionTokens={}, cost=${}",
                provider, model, durationMs, promptTokens, completionTokens, estimatedCost);
    }
    ...
    public void recordQueryError(String provider, String model, String errorType, long durationMs) {
        ...
        logger.debug("Recorded query error metrics: provider={}, model={}, errorType={}, duration={}ms",
                provider, model, errorType, durationMs);
    }
    ...
    /**
     * Estimates the cost of token usage based on provider pricing.
