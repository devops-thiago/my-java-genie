...
/**
 * Interface for embedding model providers that convert text into vector embeddings.
 * Implementations should handle the conversion of text strings into numerical vector
 * representations suitable for similarity search in vector databases.
 */
public interface EmbeddingModelProvider {
     ...
     * This method is optimized for efficiency during bulk ingestion operations.
     *
