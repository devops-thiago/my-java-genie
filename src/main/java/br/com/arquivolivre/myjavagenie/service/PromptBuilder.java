...
/**
 * Builds prompts for the language model by combining system instructions,
 * user questions, and retrieved document context.
 * Optimizes token usage by keeping prompts concise.
 */
@Component
public class PromptBuilder {
    ...
    private static final String CONTEXT_CHUNK_TEMPLATE =
            "[Source: %s%s]\n%s";
    ...
    private String formatChunk(DocumentChunk chunk) {
        String sourceFile = chunk.getMetadata() != null && chunk.getMetadata().getSourceFile() != null
