...
/**
 * Default implementation of the language model factory. Creates the appropriate provider based on
 * configuration.
 */
@Component
  ...
  public LanguageModelProvider createProvider(ModelConfig config) {
    ...
    try {
      switch (provider.toLowerCase(Locale.ROOT)) {
        ...
        case "anthropic":
          throw new ModelInitializationException("Anthropic provider is not yet implemented");
