 ...
 * Ensures all critical components are properly configured and available before the application starts serving requests.
 */
@Component
...
public class ApplicationStartupListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        try {
            ...
            throw new IllegalStateException("Application startup failed due to model initialization error", e);
        } catch (VectorDbConnectionException e) {
            logger.error("Vector database connection failed: {}", e.getMessage());
            throw new IllegalStateException("Application startup failed due to vector database connection error", e);
        } catch (Exception e) {
    ...
    /**
     * Initializes the vector repository and verifies connectivity.
